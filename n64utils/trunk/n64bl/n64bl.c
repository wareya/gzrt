...
extern int crc_rom ( char * filename );
...
unsigned char code_boot_copy[] =
{
    ...
    0xAC, 0x64, 0x00, 0x00,  0x3C, 0x08, 0x00, 0x00, 
    0x35, 0x08, 0x46, 0x60,  0xAC, 0x68, 0x00, 0x0C, 
    0x8C, 0x62, 0x00, 0x10,  0x30, 0x42, 0x00, 0x01, 
    0x14, 0x40, 0xFF, 0xFD,  0x00, 0x00, 0x00, 0x00, 
    0x3C, 0x02, 0x80, 0x00,  0x00, 0x82, 0x10, 0x25, 
    0x00, 0x02, 0x48, 0x25,  0xBD, 0x35, 0x00, 0x00, 
    0x25, 0x08, 0xFF, 0xFC,  0x1D, 0x00, 0xFF, 0xFD, 
    0x25, 0x29, 0x00, 0x04,  0x00, 0x40, 0x00, 0x08, 
    0x00, 0x00, 0x00, 0x00
};
...
unsigned char code_fix_boot[] =
{
    ...
    0xBC, 0x55, 0x00, 0x00,  0x3C, 0x04, 0x88, 0x88,
...
int main ( int argc, char ** argv )
{
    ...
    if( crc_rom( argv[1] ) )
    {
        notice( "Fixed ROM CRC." );
    }
    else
    {
        notice( "Unable to fix ROM CRC." );
    }
